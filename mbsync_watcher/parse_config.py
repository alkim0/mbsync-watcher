    ...
    def _parse_imap_account(self):
        ...
        while self._idx < len(self._lines):
            ...
            if line.startswith('Host'):
                ...
                data['password'] = subprocess.check_output(
                ...
                raise ConfigError('Unable to parse line {}: {}'.format(
                    self._idx + 1, line))
...
if __name__ == '__main__':
    ...
    print('accounts')
    print(json.dumps(config.accounts, indent=2))
    print('stores')
    print(json.dumps(config.stores, indent=2))
    print('channels')
    print(json.dumps(config.channels, indent=2))
    print('groups')
    print(json.dumps(config.groups, indent=2))
